...
💌朋友你好：
    ...
    如果你是做 【👕带货直播】、或者 【🎮️游戏直播】 等，需要对接弹幕和商品信息，

    进行接收、发送、弹窗讲解等，那我的综合弹幕方案你千万不要错过。


🚶‍➡️一路走来，2年的时光，我的弹幕方案经过了**时间**、**用户**和**性能**的多重考验，在一次次地踩坑之后，最终形成了业内为稳定的、数不多的**全平台弹幕解决方案**。👏
...
全平台弹幕助手产品已上线，支持多个平台，且可OEM。如需了解详情，请移步至：[https://www.aiobs.cn](https://www.aiobs.cn)

![1766020563309](image/README/1766020563309.png)

![1766512278024](image/README/1766512278024.png)
...
|  29  | 星闪工作室   | -                                       | /    |  30  | 英仙座科技       | -    | /    |
|  31  | 索贝数码科技 | -                                       | /    |  32  | 音量文化传播     | -    | /    |
|  33  | 瑞尼克斯科技 | 代表作《三国全战》等，长期霸榜排行榜前5 | /    |  34  | 弦序人工智能科技 | -    | /    |

## 支持平台

测试时间：**2025-12-24  01:51**
...
| 爱直播/Alive | 正常     | 2024-10-20 | wss模式、浏览器模式、系统代理模式               |
...
| 虎牙         | 正常     | 2025-07-28 | wss模式、浏览器模式、系统代理模式               |
| Youtube      | 正常     | 2025-09-13 | wss模式、浏览器模式、系统代理模式               |
| Bigo         | 正常     | 2025-10-28 | wss模式、浏览器模式、系统代理模式               |
| Twitch       | 正常     | 2025-12-02 | wss模式、浏览器模式、系统代理模式               |
...
| 日期       | 昵称                         |    金额 |  途径  | 评价                           |
| ---------- | ---------------------------- | ------: | :----: | ------------------------------ |
| 2025-09-08 | Wyn                          |   66.00 | 支付宝 | "你的软件做得很好，支持一下"   |
...
2. 本人只是用C#重构一遍已经存在的技术和方案，为了方便在windows和macos上直接窗体运行，所以你们要拿去干嘛，与本人无关！
3. 本人郑重声明：本代码库所有代码均只用于学习研究交流，严禁用于包括但不限于商业谋利、破坏系统、盗取个人信息等不良不法行为！
4. 本人强烈谴责：违反本人声明，及使用所产生的一切后果均由违反声明使用者承担！
5. 侵权或涉及相关利益请联系我，微信：**xhhdqq**
6. ![1707033446516](Screenshots/README/1707033446516.png)
