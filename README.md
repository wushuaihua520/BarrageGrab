...
💌朋友你好：
    ...
    如果你是做**带货直播**👕、或者**游戏直播**🎮️等，需要对接弹幕，那我的弹幕方案你不要错过。
...
| 测试时间           | 抖音 | 快手 | 视频号 | Tiktok | 斗鱼 | 拼多多 | 京东 | 爱直播 | 小红书 | 美团 | Facebook |
| ------------------ | ---- | ---- | ------ | ------ | ---- | ------ | ---- | ------ | ------ | ---- | -------- |
| 2025-03-06  13:03 | 正常 | 正常 | 正常   | 正常   | 正常 | 正常   | 正常 | 正常   | 正常   | 正常 | 正常     |
...
* [X] 爱直播（完成时间：2024-10-20【wss模式、浏览器模式、系统代理模式】）
* [X] 小红书（完成时间：2024-12-28【wss模式】）
* [X] Facebook（完成时间：2025-01-23【wss模式、浏览器模式】）
* [X] 美团（完成时间：2025-03-05【wss模式、浏览器模式】）
* [ ] B站（Coding）
* [ ] 淘宝（Coding）
* [ ] bilibili（Coding）
* [ ] Acfun
...
| 日期       | 昵称          |    金额 |  途径  | 评价                           |
| ---------- | ------------- | ------: | :----: | ------------------------------ |
| 2025-03-05 | 小鹏          |   66.00 |  微信  | "大哥，用了开源版能用"         |
