...
| 测试时间         | 抖音      | 快手      |
| ---------------- | --------- | --------- |
| 2024-03-22 17:21 | **正常** | **正常** |

## 支持平台

* [X] 抖音（完成时间：2024-02-23）【抖音协议服务器级别，还需要进行些许改进，取得登录后的cookie，带入连接中即可】
* [X] 快手（完成时间：2024-03-08）【由于ks政策原因（你懂的~），网上相关资料少得可怜，故此版仅供内部小规模使用，请联系码主VX：xhhdqq】
* [ ] Tiktok（Coding）
* [ ] bilibili（Coding）
* [ ] 视频号（Coding）
* [ ] 斗鱼
