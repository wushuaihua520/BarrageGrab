...
| 测试时间           | 抖音           | 快手           | 视频号         | Tiktok         | 斗鱼           | 拼多多    |
| ------------------ | -------------- | -------------- | -------------- | -------------- | -------------- | --------- |
| 2024-08-27  11:40 | **正常** | **正常** | **正常** | **正常** | **正常** | **正常** |

## 支持平台

* [X] 抖音（完成时间：2024-02-23）【有wss直连、长轮询、webview监听、系统代理4种版本；wss直连解决了x-bogus签名问题，更快更稳定】
* [X] 快手（完成时间：2024-03-08）【有wss直连、webview监听、网卡监听3种版本，另有免登录、防封控版本】
* [X] 视频号（完成时间：2024-04-05【有hook、长轮训、网卡监听3种版本】）
* [X] Tiktok（完成时间：2024-05-10【有wss直连、长轮询、webview监听、网卡监听4种版本；其中Webview版稳定实惠，wss解决了签名问题，更快更稳定，全网难寻】）
* [X] 斗鱼（完成时间：2024-07-10【收、发弹幕，wss直连】）
* [X] 拼多多（完成时间：2024-08-08【wss直连、webview、网卡监听3种版本】）
* [ ] 淘宝（Coding）
* [ ] bilibili（Coding）
* [ ] 美团（Coding）
* [ ] Acfun
...
| 日期       | 昵称           |    金额 |  途径  | 评价                             |
| ---------- | -------------- | ------: | :----: | -------------------------------- |
| 2024-08-18 | Tiktok互游出海 |   88.00 |  微信  | “好项目，小弟佩服！”           |
